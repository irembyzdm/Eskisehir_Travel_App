...
class _SideBarState extends State<SideBar> {
  List<Map> menu = [
    {'title': 'Etkinlikler', 'routeName': '/activities'},
    {'title': 'Oteller', 'routeName': '/hotels'},
    {'title': 'Alışveriş', 'routeName': '/alisveris'},
    {'title': 'Restoranlar', 'routeName': '/restoran'},
    {'title': 'Ulaşım', 'routeName': '/ulasim'},
  ];
